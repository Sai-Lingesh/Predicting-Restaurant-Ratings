...
st.title("Restaurant Rating Prediction Application")

st.caption("This Application helps you to predict a restaurant review class")
...
st.caption("Contact - www.linkedin.com/in/sai-lingesh")